# N₂O–Paraffin Burn-Rate Research Library

This folder holds a curated literature set on **regression-rate (burn-rate) variation** for hybrid rockets using **nitrous oxide + paraffin**.

| Document | Purpose |
|----------|---------|
| [`INDEX.md`](INDEX.md) | Master index of all sources, DOIs, formats, and local downloads |
