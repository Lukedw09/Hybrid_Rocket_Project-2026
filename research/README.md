...
Topic folders under `research/` (open each folder’s `README.md`):

| Tab | Path | Focus |
|-----|------|--------|
| **N₂O–Paraffin burn rate** | [`N2O_paraffin_burn_rate/`](N2O_paraffin_burn_rate/) | Regression-rate literature, `a`/`n`, safety procedures |
